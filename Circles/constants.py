...
ACCESS_REQUEST_NOTIFICATION_BODY_SECOND_DEGREE = "{} is in {}'s circle"
ACCESS_REQUEST_ACCEPTED_BODY = "{} accepted your card request. Click to go to chat."
ACCESS_REQUEST_DECLINED_BODY = "{} declined your card request"
ACCESS_REQUEST_ACCEPTED_TITLE = "Card request accepted"
ACCESS_REQUEST_DECLINED_TITLE = "Card request declined"

# Posts
POST_NOTIFICATION_TYPE = "post"
POST_NOTIFICATION_TITLE = "New broadcast from {}"
POST_NOTIFICATION_BODY = "{} just sent a short message to their Circle."
...
FRIEND_REQUEST_NOTIFICATION_TITLE = "New Invite"
FRIEND_REQUEST_NOTIFICATION_BODY = "{} wants to add you to their Circle"
FRIEND_REQUEST_ACCEPTED_TITLE = "{} accepted your invite"
FRIEND_REQUEST_DECLINED_TITLE = "{} declined your invite"
